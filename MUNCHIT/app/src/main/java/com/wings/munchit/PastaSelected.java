...
import static com.wings.munchit.Tab3.EXTRA_UR;
import static com.wings.munchit.Tab3.EXTRA_bdesc;
import static com.wings.munchit.Tab3.EXTRA_burger;
import static com.wings.munchit.Tab3.EXTRA_bprice;

public class PastaSelected extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pasta_selected);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rate == true) {
                    ...
                    Toast.makeText(PastaSelected.this, "success", Toast.LENGTH_LONG).show();

                }
                else{
                    Toast.makeText(PastaSelected.this, "data is not  inserted", Toast.LENGTH_LONG).show();}
