...
import static com.wings.munchit.Tab6.EXTRA_UR;
import static com.wings.munchit.Tab6.EXTRA_bdesc;
import static com.wings.munchit.Tab6.EXTRA_bprice;
import static com.wings.munchit.Tab6.EXTRA_burger;

public class DessertSelected extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dessert_selected);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rate == true) {
                    ...
                    Toast.makeText(DessertSelected.this, "success", Toast.LENGTH_LONG).show();

                }
                else{
                    Toast.makeText(DessertSelected.this, "data is not  inserted", Toast.LENGTH_LONG).show();}
